...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell.senderUsername.text == Auth.auth().currentUser?.email {
            ...
            cell.avatarImageView.backgroundColor = UIColor.lightGray
            cell.avatarImageView.backgroundColor = UIColor.lightGray
        }
    ...
    func retrieveMessages(){
        ...
        messageDB.observe(.childAdded, with: { (snapshot) in
            ...
            let message: Message = Message(sender,text)
        ...
        messageDB.observe(.childRemoved, with: { (snapshot) in
            let snapshotValue = snapshot.value as! Dictionary<String,String>
    ...
    @objc func keyboardWillShow(_ notification: Notification) {
        ...
        UIView.animate(withDuration: 0.5){
            ...
            self.heightConstraint.constant = CGFloat(self.keyboardHeight + 20)
            
            self.view.layoutIfNeeded() //redraws screen when contraint changes
